...
@NgModule({
  declarations: [],
  imports: [
    NgxSimpleIconsModule.pick({ typescript, csharp, angular, git, microsoftsqlserver, mongodb, html5, css3, cplusplus, java, dotnet, redux, express, docker, azuredevops, githubactions, kubernetes, materialdesign, bootstrap, github, linkedin })
  ],
  exports: [
    MatToolbarModule,
    MatCheckboxModule,
